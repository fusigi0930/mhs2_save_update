...
void CSaveUpdater::save_update(QString filename) {
    ...
    *pMoney = 0x7fffffff;
    ...
    UPDATE_SAVEDATA(&fbuf[0], sItemRecover, 999);
    UPDATE_SAVEDATA(&fbuf[0], sItemSupport, 999);
    UPDATE_SAVEDATA(&fbuf[0], sItemGrowup, 999);
    UPDATE_SAVEDATA(&fbuf[0], sItemBuilding, 999);
    UPDATE_SAVEDATA(&fbuf[0], sItemSource, 999);
